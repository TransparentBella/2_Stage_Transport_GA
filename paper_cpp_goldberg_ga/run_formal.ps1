...
$exe = Join-Path $scriptDir "paper_ga_goldberg.exe"
...
& $exe --instance-dir "$instanceDir" --out-dir "$outDir" --population 50 --generations 2000 --elitism-interval 50 --mutation-rate 0.03 --seed 42 --checkpoint-interval 1 --resume
exit $LASTEXITCODE
