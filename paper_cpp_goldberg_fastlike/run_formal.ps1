...
& $exe --instance-dir "$instanceDir" --out-dir "$outDir" --population 50 --generations 1000 --elitism-interval 50 --mutation-rate 0.03 --seed 42 --checkpoint-interval 1 --resume
exit $LASTEXITCODE
